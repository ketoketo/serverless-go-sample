# serverless-go-sample

This is a sample template for serverless-go-sample - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name serverless-go-sample \
...
aws cloudformation describe-stacks \
    --stack-name serverless-go-sample --query 'Stacks[].Outputs'
```
